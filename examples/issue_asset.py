...
issuer=client.Client(private_key=issuer_private_key)
distributor=client.Client(private_key=distributor_private_key)

result=issuer.issue_asset(distributor.private_key,asset_code='LINK',amount=10000)
print(result)
